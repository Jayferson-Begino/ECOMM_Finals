...
if(isset($_POST['order_btn'])){
   ...
   $address = mysqli_real_escape_string($conn, 'House No. '. $_POST['flat'].', '. $_POST['street'].', '. $_POST['country'].', '. $_POST['city'].', '. $_POST['state'].' - '. $_POST['pin_code']);
...
<section class="display-order">
   ...
   <div class="comp-total">Product Subtotal: <span>₱<?php echo $grand_total; ?>.00</span> </div>
   <div class="comp-total">Shipping Fee: <span> ₱60.00 </div>
   <div class="grand-total"> Total Amount: <span>₱<?php echo $grand_total + 60; ?>.00 </span></div>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <select name="method">
               ...
               <option value="paytm">Debit</option>
            </select>
         </div>
         <div class="inputBox">
            <span>House NO.: </span>
