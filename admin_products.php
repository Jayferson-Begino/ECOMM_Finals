...
if(isset($_POST['update_product'])){
   ...
   mysqli_query($conn, "UPDATE `products` SET name = '$update_name', product_qty = '$update_qty', price = '$update_price' WHERE id = '$update_p_id'") or die('Query failed!');
...
<section class="edit-product-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="number" name="update_qty" value="<?php echo $fetch_update['product_qty']; ?>" min="0" class="box" required placeholder="Enter Product Quantity">
